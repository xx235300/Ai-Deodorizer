...
**Ai-Deodorizer** 是一个 OpenClaw Skill，能够将 AI 生成的文本转换为自然、像人类书写的内容。基于 25 种 AI 写作模式检测器 + 两轮改写策略 + Soul 注入原则。支持**中英文**内容。
...
- **中文支持** — 内置中文 AI 高频词汇对照表（25项）
- **英文支持** — 内置英文 AI 高频词汇对照表（20项）
- **三种去味强度** — light / medium / strong，可调节改写深度
...
**英文 AI 特征** — 详见 [METHODOLOGY.md](METHODOLOGY.md) 第八章，包含英文 AI 高频词汇表（20项）和英文 AI 句式禁用表。
...
- 新增英文 AI 写作特征表（METHODOLOGY.md 第八章）
- SKILL.md 内嵌完整两轮改写 Prompt
- 三种去味强度（light/medium/strong）说明完善
- SKILL.md frontmatter 增加 `version: 2.0.0`
